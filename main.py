...
while True:
    ...
    for (i, c) in enumerate(contorno):
        ...
        centro = pega_centro(x, y, w, h)#ponto que o porco esta
        centro = list(centro)
        print(centro)
        ...
        if pontos >1:
            if cont>1:
                centro[0] = (centro[0] + ultimo[0] )//2
                centro[1] = (centro[1] + ultimo[1] )//2
            continue


        centro = list(centro)
        if cont>1:
            centro[0] = (centro[0] + ultimo[0] + penultimo[0])//3
            centro[1] = (centro[1] + ultimo[1] + penultimo[1])//3
